          ...
          >
            <Paper>
              <ClickAwayListener onClickAway={el => handleClose(el, '')}>
                ...
                >
                  <MenuItem onClick={el => handleClose(el, 'market')} disabled={widgets['market']}>
                    {KnownComponents['market']}
                  </MenuItem>
                  <MenuItem onClick={el => handleClose(el, 'trades')} disabled={widgets['trades']}>
                    {KnownComponents['trades']}
                  </MenuItem>
                  <MenuItem onClick={el => handleClose(el, 'candle')} disabled={widgets['candle']}>
                    {KnownComponents['candle']}
                  </MenuItem>
