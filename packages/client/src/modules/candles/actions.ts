...
export const CandleActions = {
  subscribeToSymbol: createAction<CANDLE_ACTION_TYPES.CANDLE_SUBSCRIBE_TO_SYMBOL, SubscribeToSymbolActionPayload>(
    CANDLE_ACTION_TYPES.CANDLE_SUBSCRIBE_TO_SYMBOL
  ),
};
